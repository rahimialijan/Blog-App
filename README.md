...
```sh
  cd my-folder
  git clone git@github.com:rahimialijan/Blog-App.git
```
...
```sh
  cd my-folder
  git git@github.com:rahimialijan/Blog-App.git
```
...
Feel free to check the [issues page](https://github.com/rahimialijan/Blog-App/issues).
